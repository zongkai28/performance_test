...
1. Install [ROS 2](https://docs.ros.org/en/dashing/index.html)
...
- This plugin will use the ROS 2 RMW implementation that is configured on your system.
  - ROS 2 Dashing is pre-configured to use rmw_fastrtps_cpp.
    - Follow [these instructions](https://docs.ros.org/en/ros2_documentation/dashing/Tutorials/Working-with-multiple-RMW-implementations.html)
